...
<div class="wrapper">
                    ...
                    <div class="about foo">
                        <div class="about__inner">
                            ...
                            <div class="about__icon">
                                <img src="${pageContext.request.contextPath}/resources/assets/images/others/icon/1.png" alt="icon images">
                            </div>
                        </div>
                ...
                <div class="col-md-4 col-lg-3 col-sm-6 col-xs-12">
                    <div class="about foo">
                        <div class="about__inner">
                            ...
                            <div class="about__icon">
                                <img src="${pageContext.request.contextPath}/resources/assets/images/others/icon/2.png" alt="icon images">
                            </div>
                        </div>
                ...
                <div class="col-md-4 col-lg-3 hidden-sm col-xs-12">
                    <div class="about foo">
                        <div class="about__inner">
                            ...
                            <div class="about__icon">
                                <img src="${pageContext.request.contextPath}/resources/assets/images/others/icon/3.png" alt="icon images">
                            </div>
                        </div>
                        <div class="about__inner about__hober__info">
                            <h2><a href="about.html">OUR CERTIFICATE</a></h2>
                        ...
                        <div class="project__itm foo">
                            <div class="project__thumb">
                                <a href="single-project.html">
                                    <img src="${pageContext.request.contextPath}/resources/assets/images/lst-project-3/1.jpg" alt="project images">
                                </a>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="project__itm foo">
                                    <div class="project__thumb">
                                        <a href="single-project.html">
                                            <img src="${pageContext.request.contextPath}/resources/assets/images/lst-project-3/2.jpg" alt="project images">
                                        </a>
                                        <div class="project__hover__info">
                                            <div class="project__action">
                                                <h2><a href="single-project.html">CONSTRUCTION</a></h2>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="project__itm foo">
                                    <div class="project__thumb">
                                        <a href="single-project.html">
                                            <img src="${pageContext.request.contextPath}/resources/assets/images/lst-project-3/3.jpg" alt="project images">
                                        </a>
                                        <div class="project__hover__info">
                                            <div class="project__action">
                                                <h2><a href="single-project.html">CONSTRUCTION</a></h2>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="project__itm foo">
                                    <div class="project__thumb">
                                        <a href="single-project.html">
                                            <img src="${pageContext.request.contextPath}/resources/assets/images/lst-project-3/4.jpg" alt="project images">
                                        </a>
                                        <div class="project__hover__info">
                                            <div class="project__action">
                                                <h2><a href="single-project.html">CONSTRUCTION</a></h2>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="project__itm foo">
                                    <div class="project__thumb">
                                        <a href="single-project.html">
                                            <img src="${pageContext.request.contextPath}/resources/assets/images/lst-project-3/5.jpg" alt="project images">
                                        </a>
                                        <div class="project__hover__info">
                                            <div class="project__action">
                                                <h2><a href="single-project.html">CONSTRUCTION</a></h2>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-12 col-xs-12">
                    <div class="counterup__left__thumb">
                        <img src="${pageContext.request.contextPath}/resources/assets/images/about/4.png" alt="images">
                    </div>
                </div>
                <div class="col-md-8 col-sm-12 col-xs-12">
                    ...
                    <div class="htc__counterup__wrap" style="background: rgba(0, 0, 0, 0) url(${pageContext.request.contextPath}/resources/assets/images/bg/10.png) no-repeat scroll center center / cover ;">
    ...
    <section class="htc__testimonial__area ptb--130" data--gray__overlay="9.5" style="background: rgba(0, 0, 0, 0) url(${pageContext.request.contextPath}/resources/assets/images/bg/1.jpg) no-repeat fixed center center / cover ;">
        <div class="container">
            <div class="row">
                ...
                <div class="htc__blog__wrap mt--30 clearfix">
                        ...
                        <div class="blog foo">
                            <div class="blog__thumb">
                                <a href="blog-details.html">
                                    <img src="${pageContext.request.contextPath}/resources/assets/images/blog/blog-img/1.jpg" alt="blog image">
                                </a>
                    ...
                    <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                        <div class="blog foo">
                            <div class="blog__thumb">
                                <a href="blog-details.html">
                                    <img src="${pageContext.request.contextPath}/resources/assets/images/blog/blog-img/2.jpg" alt="blog image">
                                </a>
                                <div class="blog__hover__info">
                                    <ul class="blog__meta">
                                        <li>By : <a href="#">Kalvin</a></li>
                    ...
                    <div class="col-md-4 col-lg-4 hidden-sm col-xs-12">
                        <div class="blog foo">
                            <div class="blog__thumb">
                                <a href="blog-details.html">
                                    <img src="${pageContext.request.contextPath}/resources/assets/images/blog/blog-img/3.jpg" alt="blog image">
                                </a>
                                <div class="blog__hover__info">
                                    <ul class="blog__meta">
                                        <li>By : <a href="#">Kalvin</a></li>
